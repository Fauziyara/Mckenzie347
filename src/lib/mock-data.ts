...
export const mockPairs: Pair[] = [
  ...
  makePair("0xpair0200000000000000000000000000000000000020", tokens.SOL, tokens.USDC, 1.23, 234000, 360, 890000, 567, 123000000, 8.9, 18.7, 45.3, 0, 0, 6700, 20, 2, 1, 5, 2, 90, 0, 25),
